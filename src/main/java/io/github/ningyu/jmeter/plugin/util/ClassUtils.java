	...
	public static void parseParameter(List<String> paramterTypeList, 
		...
		try {
			...
			if (className.equals("int")) {
				...
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.INT_ARRAY_DEFAULT : JsonUtils.readValue(arg.getParamValue(), new TypeToken<int[]>() {}.getType()));
			} else if (className.equals("double")) {
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.DOUBLE_DEFAULT : Double.parseDouble(arg.getParamValue()));
			}  else if (className.equals("double[]")) {
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.DOUBLE_ARRAY_DEFAULT : JsonUtils.readValue(arg.getParamValue(), new TypeToken<double[]>() {}.getType()));
			} else if (className.equals("short")) {
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.SHORT_DEFAULT : Short.parseShort(arg.getParamValue()));
			} else if (className.equals("short[]")) {
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.SHORT_ARRAY_DEFAULT : JsonUtils.readValue(arg.getParamValue(), new TypeToken<short[]>() {}.getType()));
			} else if (className.equals("float")) {
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.FLOAT_DEFAULT : Float.parseFloat(arg.getParamValue()));
			} else if (className.equals("float[]")) {
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.FLOAT_ARRAY_DEFAULT : JsonUtils.readValue(arg.getParamValue(), new TypeToken<float[]>() {}.getType()));
			} else if (className.equals("long")) {
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.LONG_DEFAULT : Long.parseLong(arg.getParamValue()));
			} else if (className.equals("long[]")) {
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.LONG_ARRAY_DEFAULT : JsonUtils.readValue(arg.getParamValue(), new TypeToken<long[]>() {}.getType()));
			} else if (className.equals("byte")) {
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.BYTE_DEFAULT : Byte.parseByte(arg.getParamValue()));
			} else if (className.equals("byte[]")) {
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.BYTE_ARRAY_DEFAULT : JsonUtils.readValue(arg.getParamValue(), new TypeToken<byte[]>() {}.getType()));
			} else if (className.equals("boolean")) {
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.BOOLEAN_DEFAULT : Boolean.parseBoolean(arg.getParamValue()));
			} else if (className.equals("boolean[]")) {
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.BOOLEAN_ARRAY_DEFAULT : JsonUtils.readValue(arg.getParamValue(), new TypeToken<boolean[]>() {}.getType()));
			} else if (className.equals("char")) {
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.CHAR_DEFAULT : arg.getParamValue().charAt(0));
			} else if (className.equals("char[]")) {
				paramterTypeList.add(arg.getParamType());
				parameterValuesList.add(isBlank(arg.getParamValue()) ? Constants.CHAT_ARRAY_DEFAULT : JsonUtils.readValue(arg.getParamValue(), new TypeToken<char[]>() {}.getType()));
				...
				parameterValuesList.add(isBlank(arg.getParamValue()) ? null : String.valueOf(arg.getParamValue()));
					...
					|| className.equals("string[]")) {
				paramterTypeList.add("java.lang.String[]");
				parameterValuesList.add(isBlank(arg.getParamValue()) ? null : JsonUtils.readValue(arg.getParamValue(), new TypeToken<String[]>() {}.getType()));
				...
				parameterValuesList.add(isBlank(arg.getParamValue()) ? null : Integer.valueOf(arg.getParamValue()));
					...
					|| className.equals("integer[]")) {
				paramterTypeList.add("java.lang.Integer[]");
				parameterValuesList.add(isBlank(arg.getParamValue()) ? null : JsonUtils.readValue(arg.getParamValue(), new TypeToken<Integer[]>() {}.getType()));
				...
				parameterValuesList.add(isBlank(arg.getParamValue()) ? null : Double.valueOf(arg.getParamValue()));
					...
					|| className.equals("Double[]")) {
				paramterTypeList.add("java.lang.Double[]");
				parameterValuesList.add(isBlank(arg.getParamValue()) ? null : JsonUtils.readValue(arg.getParamValue(), new TypeToken<Double[]>() {}.getType()));
				...
				parameterValuesList.add(isBlank(arg.getParamValue()) ? null : Short.valueOf(arg.getParamValue()));
					...
					|| className.equals("Short[]")) {
				paramterTypeList.add("java.lang.Short[]");
				parameterValuesList.add(isBlank(arg.getParamValue()) ? null : JsonUtils.readValue(arg.getParamValue(), new TypeToken<Short[]>() {}.getType()));
				...
				parameterValuesList.add(isBlank(arg.getParamValue()) ? null : Long.valueOf(arg.getParamValue()));
					...
					|| className.equals("Long[]")) {
				paramterTypeList.add("java.lang.Long[]");
				parameterValuesList.add(isBlank(arg.getParamValue()) ? null : JsonUtils.readValue(arg.getParamValue(), new TypeToken<Long[]>() {}.getType()));
				...
				parameterValuesList.add(isBlank(arg.getParamValue()) ? null : Float.valueOf(arg.getParamValue()));
					...
					|| className.equals("Float[]")) {
				paramterTypeList.add("java.lang.Float[]");
				parameterValuesList.add(isBlank(arg.getParamValue()) ? null : JsonUtils.readValue(arg.getParamValue(), new TypeToken<Float[]>() {}.getType()));
				...
				parameterValuesList.add(isBlank(arg.getParamValue()) ? null : Byte.valueOf(arg.getParamValue()));
					...
					|| className.equals("Byte[]")) {
				paramterTypeList.add("java.lang.Byte[]");
				parameterValuesList.add(isBlank(arg.getParamValue()) ? null : JsonUtils.readValue(arg.getParamValue(), new TypeToken<Byte[]>() {}.getType()));
